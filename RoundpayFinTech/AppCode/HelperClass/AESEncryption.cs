...
namespace RoundpayFinTech.AppCode.HelperClass
{
    ...
    {
		public static string OpenSSLEncrypt(string plainText, string passphrase, Int32 KeySize = 256)
		{
			// generate salt
			byte[] key, iv;
		...
		public static string OpenSSLDecrypt(string encrypted, string passphrase, Int32 KeySize = 256)
		{
			// base 64 decode
