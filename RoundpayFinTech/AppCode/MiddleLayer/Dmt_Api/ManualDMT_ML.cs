...
{
    public class ManualDMT_ML : IMoneyTransferAPIML
    {
        ...
        private readonly ManualDMTAppSetting appSetting;

        public ManualDMT_ML(IHttpContextAccessor accessor, IHostingEnvironment env, IDAL dal, string APICode)
        {
            _accessor = accessor;
            _env = env;
        ...
        private ManualDMTAppSetting AppSetting(string apiCode)
        {
            var setting = new ManualDMTAppSetting();
            try
            {
                setting = new ManualDMTAppSetting
                {
                    VerificationAPICode = Configuration["DMR:" + apiCode + ":VerificationAPICode"],
        ...
        public DMRTransactionResponse AccountTransfer(MTAPIRequest request)
        {
            var res = new DMRTransactionResponse
            {
                Statuscode = RechargeRespType.SUCCESS,
                Msg = RechargeRespType._SUCCESS,
                VendorID = "",
                LiveID = "",
                ErrorCode = ErrorCodes.Transaction_Successful
            };
