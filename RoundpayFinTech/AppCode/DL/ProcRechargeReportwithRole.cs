...
{
    public class ProcRechargeReportwithRole : IProcedureAsync
    {
        private readonly IDAL _dal;
        public ProcRechargeReportwithRole(IDAL dal) => _dal = dal;
        public string GetName() => "Proc_RechargeReportwithRole";
        public async Task<object> Call(object obj)
        {
            ...
            var _alist = new List<RechargeReportResponse>();
            try
            {
                ...
                if (!dt.Columns.Contains("Msg"))
                {
                    ...
                    {
                        var item = new RechargeReportResponse
                        {
                            ...
                            ApiComm = dt.Rows[i]["_APIComAmt"] is DBNull ? 0M : Convert.ToDecimal(dt.Rows[i]["_APIComAmt"]),
                        };
