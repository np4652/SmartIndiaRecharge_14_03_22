...
{
    public class ProcUpdateBeneficiary : IProcedure
    {
        private readonly IDAL _dal;
        public ProcUpdateBeneficiary(IDAL dal) => _dal = dal;
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    if (req.Statuscode == ErrorCodes.One)
                    {
                        ...
                        req.Account= dt.Rows[0]["_Account"] is DBNull ? string.Empty : dt.Rows[0]["_Account"].ToString();
                        req.SenderNo = dt.Rows[0]["_SenderNo"] is DBNull ? string.Empty : dt.Rows[0]["_SenderNo"].ToString();
        ...
        public string GetName() => "proc_UpdateBeneficiary";
    }
}
