...
{
    public class ProcMoveToWalletActive : IProcedure
    {
        private readonly IDAL _dal;
        public ProcMoveToWalletActive(IDAL dal) => _dal = dal;
        public object Call(object obj)
        {
            ...
            SqlParameter[] param = {
                ...
                new SqlParameter("@MTWID", _req.CommonInt),
        ...
        public string GetName() => "Proc_MoveToWallet_ActiveWithOperator";
    }
}
