...
{
    public class ProcUpdateStatusPartner : IProcedure
    {
        private readonly IDAL _dal;
        public ProcUpdateStatusPartner(IDAL dal)
        {
            _dal = dal;
        }
        public object Call(object obj)
        {
            ...
            SqlParameter[] param = {
                ...
                new SqlParameter("@Status", _req.StatusColumn),
        ...
        {
            return "proc_GetPartnerUpdateStatus";
        }
    }
}