...
{
	public class ProcUpdateSubCategoryLvl2 : IProcedure
	{
		private readonly IDAL _dal;

		public ProcUpdateSubCategoryLvl2(IDAL dal) => _dal = dal;
		...
		public object Call(object obj)
		{
			...
			SqlParameter[] param = {
				...
				new SqlParameter("@Commission", req.CommonDecimal),
				new SqlParameter("@CommissionType", req.CommonBool2)
			};
			try
			{
		...
		public string GetName() => "Proc_UpdateSubCategoryLvl2";
	}
}
