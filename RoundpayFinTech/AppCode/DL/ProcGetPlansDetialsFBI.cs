...
{
    public class ProcGetPlansDetialsFBI : IProcedure
    {
        private readonly IDAL _dal;
        public ProcGetPlansDetialsFBI(IDAL dal) => _dal = dal;
        ...
        public string GetName() => "proc_GetPlansDetialsFBI";
    }


    public class ProcGetPlanTypeID : IProcedure
    {
        private readonly IDAL _dal;
        public ProcGetPlanTypeID(IDAL dal) => _dal = dal;
        public object Call(object obj)
        {
            var req = (CommonReq)obj;
            ...
            SqlParameter[] param = {
                ...
                new SqlParameter("@PlanType",req.CommonStr)
            };
            ...
            try
            {
                ...
                if (ds.Tables.Count > 0)
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        if (res.Statuscode == ErrorCodes.One)
                        {
                            res.CommonInt = dt.Rows[0]["_PlanID"] is DBNull ? 0 : Convert.ToInt32(dt.Rows[0]["_PlanID"]);
                        }
                    }
                }
        ...
        public object Call() => throw new NotImplementedException();
        public string GetName() => "Proc_GetPlanTypeID";
    }
}
