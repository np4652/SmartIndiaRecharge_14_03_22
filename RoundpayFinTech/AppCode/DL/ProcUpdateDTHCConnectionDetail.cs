...
{
    public class ProcUpdateDTHCConnectionDetail : IProcedure
    {
        private readonly IDAL _dal;
        public ProcUpdateDTHCConnectionDetail(IDAL dal)
        {
            _dal = dal;
        }
        public object Call(object obj)
        {
            var req = (DTHCommissionRequest)obj;
            ...
            SqlParameter[] param =
            {
                ...
                new SqlParameter("@PID",req.Commission.PackageID),
        ...
        public string GetName() => "proc_UpdateDTHCConnectionDetail";
    }
}
