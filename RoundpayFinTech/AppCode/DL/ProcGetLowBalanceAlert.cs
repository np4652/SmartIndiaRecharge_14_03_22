...
{
    public class ProcGetLowBalanceAlert : IProcedure
    {
        private readonly IDAL _dal;
        public ProcGetLowBalanceAlert(IDAL dal) => _dal = dal;        
        ...
        public string GetName() => "proc_GetLowBalanceAlert";
    }
}
