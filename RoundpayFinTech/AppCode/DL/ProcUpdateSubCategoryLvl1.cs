...
{
    public class ProcUpdateSubCategoryLvl1 : IProcedure
	{
		private readonly IDAL _dal;

		public ProcUpdateSubCategoryLvl1(IDAL dal) => _dal = dal;
		...
		public object Call(object obj)
		{
			...
			SqlParameter[] param = {
				...
				new SqlParameter("@ImageIcone", req.CommonStr2),
				new SqlParameter("@ImageBanner", req.CommonStr3)
			};
			try
			{
		...
		public string GetName() => "Proc_UpdateSubCategoryLvl1";
	}
}
