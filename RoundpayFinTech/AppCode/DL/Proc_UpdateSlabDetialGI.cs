...
{
    public class Proc_UpdateSlabDetialGI : IProcedure
    {
        private readonly IDAL _dal;
        public Proc_UpdateSlabDetialGI(IDAL dal) => _dal = dal;
        ...
        public object Call(object obj)
        {
            ...
            SqlParameter[] param =
            {
                ...
                new SqlParameter("@ComOnAmtType",req.Commission.ComOnAmtType),

                new SqlParameter("@TPComm",req.Commission.TPComm),
                new SqlParameter("@TPCommType",req.Commission.TPCommType),
                new SqlParameter("@TPAmtType",req.Commission.TPAmtType),
                new SqlParameter("@TPComOnAmtType",req.Commission.TPComOnAmtType),
        ...
        public string GetName() => "proc_UpdateSlabDetailGI";
    }
}
