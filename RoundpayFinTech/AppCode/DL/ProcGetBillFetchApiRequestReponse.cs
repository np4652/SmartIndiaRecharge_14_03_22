...
{
    public class ProcGetBillFetchApiRequestReponse : IProcedureAsync
    {
        private readonly IDAL _dal;
        public ProcGetBillFetchApiRequestReponse(IDAL dal) => _dal = dal;
        ...
        public async Task<object> Call(object obj)
        {
            ...
            SqlParameter[] param = {
                ...
                new SqlParameter("@TID", req.CommonStr)
            };
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    for (int i = 0; i < dt.Rows.Count; i++)
                    {
                        ...
                        item._ResponseTime = dt.Rows[i]["_EntryDate"].ToString();
                        list.Add(item);
                    }
                }
                else
        ...
        public string GetName() => "Proc_GetBillFetchAPiUrlResponse";
    }
}
