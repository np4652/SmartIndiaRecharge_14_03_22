...
{
    public class ProcUpdateSlabDetailCircleAPI : IProcedure
    {
        private readonly IDAL _dal;
        public ProcUpdateSlabDetailCircleAPI(IDAL dal) => _dal = dal;
        public object Call(object obj)
        {
            ...
            SqlParameter[] param = {
                ...
                new SqlParameter("@APIID",req.Commission.APIID),
        ...
        public string GetName() => "proc_UpdateSlabDetail_CircleAPI";
    }
}
