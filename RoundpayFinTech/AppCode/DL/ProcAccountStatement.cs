...
{
    public class ProcAccountStatement : IProcedureAsync
    {
        private readonly IDAL _dal;
        public ProcAccountStatement(IDAL dal) => _dal = dal;
        public string GetName() => "proc_AccountStatement";
        public async Task<object> Call(object obj)
        {
            ...
            {
                var _ = new RoundpayFinTech.AppCode.DL.ProcPageErrorLog(_dal).Call(new ErrorLog
                {
