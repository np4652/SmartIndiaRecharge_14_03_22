...
{
    public class ProcUserBankRequest : IProcedure
    {
        private readonly IDAL _dal;
        public ProcUserBankRequest(IDAL dal) => _dal = dal;
        public object Call(object obj)
        {
            ...
            SqlParameter[] param = {
                ...
                new SqlParameter("@AccountHolder",req.AccountName??string.Empty)
            };
            try
            {
        ...
        public string GetName() => "Proc_bankUpdateRequest";
    }
}
