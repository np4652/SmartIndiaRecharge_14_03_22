...
namespace RoundpayFinTech.AppCode.DL.Shopping
{
	...
	public class ProcUpdateShoppingCategoryNew : IProcedure
	{
		private readonly IDAL _dal;

		public ProcUpdateShoppingCategoryNew(IDAL dal) => _dal = dal;
		...
		public object Call(object obj)
		{
			...
			SqlParameter[] param = {
				...
				new SqlParameter("@Commission", req.CommonInt2),
				...
				new SqlParameter("@IconeType", req.CommonStr4.Trim()),
		...
		public string GetName() => "proc_updateShoppingCategoryNew";
	}
}
