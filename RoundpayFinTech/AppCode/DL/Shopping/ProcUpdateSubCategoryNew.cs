...
{
    public class ProcUpdateSubCategoryNew : IProcedure
    {
        private readonly IDAL _dal;

        public ProcUpdateSubCategoryNew(IDAL dal) => _dal = dal;
        ...
        public object Call(object obj)
        {
            ...
            SqlParameter[] param = {
                ...
                new SqlParameter("@ParentId", req.CommonInt2),
                new SqlParameter("@MainCategoryId", req.CommonInt4),
        ...
        public string GetName() => "Proc_UpdateSubCategoryNew";
    }
}
