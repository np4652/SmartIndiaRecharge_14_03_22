...
{
    public class ProcUpdateBankSetting : IProcedure
    {
        private readonly IDAL _dal;
        public ProcUpdateBankSetting(IDAL dal)
        {
            _dal = dal;
        }
        public object Call(object obj)
        {
            var _req = (BankMaster)obj;
            SqlParameter[] param = {
                   new SqlParameter("@LoginID", _req.LoginID),
                   new SqlParameter("@LT", _req.LTID),
                   new SqlParameter("@BankID",_req.ID),
