...
{
    public class ProcGetUserSubscriptionCusCare : IProcedure
    {
        private readonly IDAL _dal;
        public ProcGetUserSubscriptionCusCare(IDAL dal) => _dal = dal;
        public object Call(object obj)
        {
            ...
            SqlParameter[] param = {
                ...
                new SqlParameter("@Mobile",req.CommonStr2),
                new SqlParameter("@AssignDate",req.CommonStr3),
                new SqlParameter("@OnlyTodayFollowup",req.CommonBool),
            };
        ...
        public string GetName() => "Proc_GetUserSubscriptionCuscare";
    }
